...
async function main(){
  ...
  let sortedContents = sortPacks(packsContents, selectionText);
  let closestEntry = sortedContents[0];
  let closestLink = getLink(closestEntry, selectionText);
  replaceSelection(selection, closestLink);
  renderEntry(closestEntry);
}
main();